...
const navigation = [
  ...
  { name: "Cost Estimator", href: "/cost-estimator", icon: ChartPieIcon, current: false },
  {
    name: "Saved Estimate Summaries",
    ...
    <>
      ...
      */}
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-60 lg:flex-col border-r-2 border-gray-400">
          {/* Sidebar component, swap this element with another sidebar if you like */}
